...
exports.roundTimeoutCheck = void 0;
...
exports.roundTimeoutCheck = (0, scheduler_1.onSchedule)({
    ...
    for (const roomId of roomIds) {
        try {
            ...
            const now = Date.now();
            // 타임아웃 + 5초 여유
            if (now < (current.roundEndsAt || 0) + 5000)
                continue;
            firebase_functions_1.logger.info(`[${roomId}] Round ${current.round} timed out, forcing advance`);
            ...
            firebase_functions_1.logger.error(`roundTimeoutCheck error for ${roomId}:`, error);
        }
    }
});
//# sourceMappingURL=roundTimeout.js.map