...
exports.generateOXQuizzes = generateOXQuizzes;
exports.generatePriceItems = generatePriceItems;
exports.generateBombQuizzes = generateBombQuizzes;
exports.generateDrawWords = generateDrawWords;
exports.generateTypingSentences = generateTypingSentences;
...
function pickRandomCategories(n) {
...
// ── Export 함수들 ──
async function generateOXQuizzes(count) {
...
async function generatePriceItems(count) {
    const seed = uniqueSeed();
    const prompt = `[시드: ${seed}]
...
async function generateBombQuizzes(count) {
    const seed = uniqueSeed();
    const prompt = `[시드: ${seed}]
...
async function generateDrawWords(count) {
    const seed = uniqueSeed();
...
async function generateTypingSentences(count) {
    const seed = uniqueSeed();
    const prompt = `[시드: ${seed}]
...
//# sourceMappingURL=geminiGameQuiz.js.map