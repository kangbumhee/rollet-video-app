...
const SOUND_CONFIG: Record<SoundName, { path: string; volume: number; loop?: boolean }> = {
  'countdown-tick': { path: '/sounds/countdown-tick.mp3', volume: 0.6 },
  'game-start': { path: '/sounds/game-start.mp3', volume: 0.7 },
  'click': { path: '/sounds/click.mp3', volume: 0.4 },
  'win-fanfare': { path: '/sounds/win-fanfare.mp3', volume: 0.8 },
  'lose': { path: '/sounds/lose.mp3', volume: 0.5 },
  'chat-pop': { path: '/sounds/chat-pop.mp3', volume: 0.3 },
  'prize-reveal': { path: '/sounds/prize-reveal.mp3', volume: 0.7 },
  'ticket-get': { path: '/sounds/ticket-get.mp3', volume: 0.6 },
  'roulette-spin': { path: '/sounds/roulette-spin.mp3', volume: 0.5 },
  'rps-select': { path: '/sounds/rps-select.mp3', volume: 0.5 },
